...
The overview panel has three distinct components: The hive plot, the heat map and the table. The hive plot uses the HiveR package[[@hiver]] as well as the RColorBrewer package[[@rcolorbrewer]] for colour selection. It does some other stuff based on whatever Dmitri did.
